...
if(message.member.roles.cache.some(role => role.name === 'warn')) {
    ...
    message.delete()
    message.reply(`:zipper_mouth: تم اعطائك ميوت لمدة 5 دقائق لاستخدامك كلمات غير لائقة`, message.channel);
    ...
    message.reply(`:angry: تم اعطائك انذار لاستخدامك كلمات سيئة`, message.channel);
